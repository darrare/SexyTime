...
function generateQuizSectionQuestion(quizSectionQuestion, gender) {
    ...
    content.push(`                            <input class="btn-check" type="radio" id="${quizSectionQuestion.id}_1" name="answers[${quizSectionQuestion.id}]" value="0">`);
    ...
    content.push(`                        </div>`);
    content.push(`                        <div class="col">`);
    content.push(`                            <input class="btn-check" type="radio" id="${quizSectionQuestion.id}_2" name="answers[${quizSectionQuestion.id}]" value="1">`);
    ...
    content.push(`                        </div>`);
    content.push(`                        <div class="col">`);
    content.push(`                            <input class="btn-check" type="radio" id="${quizSectionQuestion.id}_4" name="answers[${quizSectionQuestion.id}]" value="3">`);
    ...
    content.push(`                        </div>`);
    content.push(`                        <div class="col">`);
    content.push(`                            <input class="btn-check" type="radio" id="${quizSectionQuestion.id}_5" name="answers[${quizSectionQuestion.id}]" value="4">`);
